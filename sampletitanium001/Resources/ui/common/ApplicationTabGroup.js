...
function ApplicationTabGroup(Window) {
	...
	var tab1 = Ti.UI.createTab({title: L('home'),icon: '/images/KS_nav_views.png',window: win1});
	...
	//Table View Search 
	var win22=Ti.UI.createWindow({title:"Table View Search",backgroundColor:"#FFF",url:"tableView/searchTableView.js"});
	var tab22=Ti.UI.createTab({title:"Search Table View",window:win22});
	self.addTab(tab22);
	
	//Misc 
	var win23=Ti.UI.createWindow({title:"Misc",backgroundColor:"#FFF",url:"tableView/misc.js"});
